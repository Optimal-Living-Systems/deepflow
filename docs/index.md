...
║   ╚═════╝ ╚══════╝╚══════╝╚═╝     ╚═╝     ╚══════╝ ╚═════╝  ╚══╝╚══╝  ║
║                                                                         ║
║                 Deep Flo — Structured Integration Layer                 ║
║                                                                         ║
╚═════════════════════════════════════════════════════════════════════════╝
```
...
Deep Flo is a structured Deep Agents system for teams that want one runtime reachable from CLI, IDE, Langflow, and Docker.
...
Deep Flo resolves that by separating concerns:

- Deep Agents run in an isolated runtime
- Langflow talks to that runtime over explicit boundaries
- MCP and HTTP make the same Deep Flo runtime reachable from IDEs and flow tools
...
Deep Flo is the right choice when:
...
- Deep Flo is the integration and operations layer

## Credits

Deep Flo builds directly on LangChain projects and gives them full credit.
...
Deep Flo should be read as a project-specific wrapper around those systems, not as a replacement for them.

> **Disclaimer:** Deep Flo is not a LangChain product. It is a community integration layer built entirely on top of LangChain's open-source work. All core agent capabilities — Deep Agents, LangGraph, and LangSmith — belong to the LangChain team. Deep Flo adds packaging, routing, and operations around their work, and nothing more.

## Documentation Map

- [Why Deep Flo](why-deep_flo.md)
